...
class SearchConfiguration {
  Map<String, String> selectedLeagues =
      HashMap(equals: (key1, key2) => key1.compareTo(key2) == 0);
  Map<String, String> selectedNations =
      HashMap(equals: (key1, key2) => key1.compareTo(key2) == 0);
...
class LeagueCodes {
  static const String LALIGA =
      "240,241,243,448,449,450,452,457,461,462,463,467,480,481,483,1853,1860,100888,110062,110839";
  static const String PREMIER_LEAGUE =
      "1,5,7,9,10,11,13,17,18,19,95,110,144,1795,1796,1799,1808,1939,1943,1961";
  static const String LIGUE1 =
      "59,62,65,66,69,70,71,72,73,74,76,210,219,224,379,1530,1809,1816,1819,110569";
