...
class AdvancedSearchScreen extends StatefulWidget {
  ...
  AdvancedSearchScreen({@required this.searchConfiguration});
...
class _AdvancedSearchScreenState extends State<AdvancedSearchScreen> {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.of(context)
                .pop({"search_configuration": widget.searchConfiguration});
          },
        ),
        title: Text(
          "Advanced Search",
            ...
            children: [
              ...
              Padding(
                ...
                child: Wrap(
                  spacing: 10,
                  children: [
                    for (var positionName
                        in widget.searchConfiguration.positions)
                      ChoiceChip(
                          selected: widget.searchConfiguration.selectedPositions
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).pop(
                          {"search_configuration": widget.searchConfiguration});
                    },
                    child: Text(
                      "Done",
  ...
  void _onLeagueSelected(bool isSelected, String leagueKey) {
    isSelected
        ? widget.searchConfiguration.selectedLeagues.putIfAbsent(
            leagueKey, () => widget.searchConfiguration.leagues[leagueKey])
  ...
  void _onNationSelected(bool isSelected, String nationKey) {
    isSelected
        ? widget.searchConfiguration.selectedNations.putIfAbsent(
            nationKey, () => widget.searchConfiguration.nations[nationKey])
